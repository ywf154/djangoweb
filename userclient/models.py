...
class Student(models.Model):
    ...
    department = models.ForeignKey(to='Department', to_field='departmentName', verbose_name="所在学院", on_delete=models.CASCADE)
...
class Course(models.Model):
    ...
    classifier = models.SmallIntegerField(verbose_name="课程类别", choices=classifier_choices)
    attribute = models.SmallIntegerField(verbose_name="课程属性", choices=attribute_choices)
